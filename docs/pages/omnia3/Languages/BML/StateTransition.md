...
| To | Text | None | 1..1 | None | Target state when the transition happens. |
| Type | StateTransitionType | None | 1..1 | None | Type of transition. |
| Decision | Text | None | 0..1 | None | User Decision that will trigger the transition in case of decision based transitions. |
